...
> 2026-09-27 추가: [Codex 실제 창 조작 QA](m4-native-play-report.md)에서 수동/자동 저장·종료/재실행 Lv2 복원·슬롯 독립성을 확인했다. 아래 2026-09-25 표는 당시 디렉터 확인 대기 기록이다. 이동 위치·장비/강화 복원과 디렉터 G4 승인은 아직 남아 있다. 시작 지점 저장 거부 및 종료 잔존 경고 6/2도 추가 보고서에 기록했다.
