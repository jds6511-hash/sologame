...
- **담당**: pixel-artist
- **의존 문서**:
  - `docs\art\STYLE_GUIDE.md` (2장 EDG32 팔레트, 3장 아웃라인/명암/프레임 규격, 7-3장 CC0 소싱 규칙, 1-2장·8장 — 2026-07-18 개정: G2-2 스타듀밸리 비율 정합 신규격, **3-2-3장·7-5-2장 — 2026-08-20 개정: 대면적 지면 명도 대비 규칙 σ_L ≤ 10 + 확정 배합표**)
